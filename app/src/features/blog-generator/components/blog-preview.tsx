...
export const serializeBlogArticleHtml = (blog: BlogGenerationResult, sourcesMap?: Map<string, BlogSource>): string => {
...
export const serializeBlogToHtml = (blog: BlogGenerationResult, sourcesMap?: Map<string, BlogSource>): string => {
...
export const BlogPreview = ({ blog, customHtml }: BlogPreviewProps) => {
