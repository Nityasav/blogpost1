...
export function BlogEditor({ blog, initialHtml, onSave }: BlogEditorProps) {
  ...
  return (
    <div className="mx-auto w-full max-w-4xl space-y-5 rounded-[30px] border border-[#2A33A4]/20 bg-white/95 p-6 shadow-[0_35px_90px_rgba(42,51,164,0.08)] md:p-8">
      <div className="flex flex-wrap items-center justify-between gap-4 rounded-2xl border border-[#2A33A4]/12 bg-white/85 p-4 shadow-[0_22px_65px_rgba(42,51,164,0.08)]">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <Button
            ...
            variant="ghost"
            className="flex items-center gap-2 rounded-full border border-[#2A33A4]/15 px-5 py-2 text-[#2A33A4] hover:border-[#2A33A4]/30"
          >
      ...
      <div className="flex flex-wrap items-center gap-2 rounded-2xl border border-[#2A33A4]/15 bg-white/85 p-3 shadow-[0_18px_55px_rgba(42,51,164,0.06)]">
        ...
        <Button type="button" variant="secondary" onClick={handleCopyBlog} className="flex items-center gap-2">
          <CopyIcon className="h-4 w-4" />
          {copiedBlog ? "Copied" : "Copy Blog"}
        </Button>
        <Button type="button" variant="secondary" onClick={handleCopyHtml} className="flex items-center gap-2">
